...
# Initiera OpenAI-klient från miljövariabel
client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))

def ask_openai(data: dict, industry: str = "") -> str:
    try:
        prompt = f"""
Du är en försäkringsspecialist som analyserar ett dokument baserat på följande uppgifter:
...
"""
        ...
        response = client.chat.completions.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "Du är en expert på företagsförsäkringar."},
